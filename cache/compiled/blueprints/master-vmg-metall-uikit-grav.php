...
return [
    ...
    'checksum' => 'b21a7b3e07a51ec02c744883a85f8a1d',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/editable-simplemde' => [
                'file' => 'user/plugins/editable-simplemde/blueprints.yaml',
                'modified' => 1504111457
            ],
            'plugins/email' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.editable-simplemde.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.editable-simplemde.enabled',
                'validation' => 'strict'
            ],
            'plugins.email' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'editable-simplemde' => [
                    'enabled' => 'plugins.editable-simplemde.enabled'
                ],
                'email' => [
